<template>
  <div style="min-height: 100vh; background: #f9fafb;">
    ...
    <div style="max-width: 1280px; margin: 0 auto; padding: 2rem 1rem;">
      ...
      <div v-else class="profile-grid">
        ...
        <div style="background: white; border-radius: 0.5rem; padding: 2rem; border: 1px solid #e5e7eb;">
          <h2
            style="font-size: 1.25rem; font-weight: 600; color: #111827; margin: 0 0 1.5rem 0; display: flex; align-items: center; gap: 0.5rem;">
          ...
          <div style="display: flex; align-items: start; gap: 1.5rem; margin-bottom: 2rem;">
            ...
            <div style="flex-shrink: 0;">
              ...
              <div v-else
                ...
                <UserIcon v-if="!user.displayName" class="h-8 w-8 text-gray-400" />{{ user.displayName ?
          ...
          <div
            ...
            <!-- 編集権限統計 -->
            <div v-if="userStats.editableCircles > 0"
              style="text-align: center; padding: 1rem; background: #f0fdf4; border-radius: 0.5rem;">
            ...
            <div v-if="userStats.pendingRequests > 0"
              style="text-align: center; padding: 1rem; background: #fefce8; border-radius: 0.5rem;">
          ...
          <div style="border-top: 1px solid #e5e7eb; padding-top: 1.5rem;">
            ...
            <div style="display: flex; flex-wrap: wrap; gap: 1rem;">
              <button @click="showDeleteConfirm = true" :disabled="loading"
        ...
        <div v-if="currentEvent"
          ...
          <BudgetSummary :event-id="currentEvent.id" :event-name="currentEvent.name" />
        </div>
        ...
        <div style="background: white; border-radius: 0.5rem; padding: 2rem; border: 1px solid #e5e7eb;">
          ...
          <!-- エラー状態 -->
          <div v-else-if="error"
            style="background: #fef2f2; border: 1px solid #fecaca; border-radius: 0.5rem; padding: 1rem; margin-bottom: 1rem;">
            ...
            <button @click="refreshEditPermissions"
          ...
          <div v-else>
            <!-- 権限ステータス -->
            <div v-if="editPermission.hasPermission"
              style="background: #f0fdf4; border: 1px solid #bbf7d0; border-radius: 0.5rem; padding: 1rem; margin-bottom: 1rem;">
              ...
              <!-- 編集可能なサークル一覧 -->
              <div v-if="circlePermissions.length > 0"
                style="background: white; border-radius: 0.375rem; padding: 1rem;">
                <h4 style="font-size: 0.875rem; font-weight: 600; color: #166534; margin: 0 0 0.75rem 0;">編集可能なサークル</h4>
                <div style="display: flex; flex-direction: column; gap: 0.5rem;">
                  <div v-for="permission in circlePermissions.slice(0, 3)" :key="permission.id"
                  ...
                  <div v-if="circlePermissions.length > 3"
                    style="text-align: center; padding: 0.5rem; color: #6b7280; font-size: 0.75rem;">
            ...
            <div v-else-if="editPermission.isPending"
              style="background: #fefce8; border: 1px solid #fde047; border-radius: 0.5rem; padding: 1rem; margin-bottom: 1rem;">
            ...
            <div v-else
              style="background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 0.5rem; padding: 1rem; margin-bottom: 1rem;">
            ...
            <div v-if="editPermissionRequests.length > 0" style="margin-bottom: 1rem;">
              ...
              <div style="display: flex; flex-direction: column; gap: 0.5rem;">
                <div v-for="request in editPermissionRequests.slice(0, 5)" :key="request.id"
                  ...
                  <div v-if="request.status === 'rejected' && request.rejectionReason"
                    style="background: #fef2f2; border: 1px solid #fecaca; border-radius: 0.25rem; padding: 0.5rem;">
                ...
                <div v-if="editPermissionRequests.length > 5"
                  style="text-align: center; padding: 0.5rem; color: #6b7280; font-size: 0.75rem;">
            ...
            <!-- 権限統計 -->
            <div v-if="editPermission.approvedCount > 0 || editPermission.rejectedCount > 0"
              style="display: grid; grid-template-columns: repeat(auto-fit, minmax(100px, 1fr)); gap: 0.75rem; margin-bottom: 1rem;">
              <div v-if="editPermission.approvedCount > 0"
                style="text-align: center; padding: 0.75rem; background: #f0fdf4; border-radius: 0.375rem;">
                <div style="font-size: 1.25rem; font-weight: 700; color: #16a34a; margin-bottom: 0.25rem;">{{
                  editPermission.approvedCount }}</div>
                <div style="font-size: 0.75rem; color: #166534;">承認済み</div>
              </div>
              <div v-if="editPermission.rejectedCount > 0"
                style="text-align: center; padding: 0.75rem; background: #fef2f2; border-radius: 0.375rem;">
                <div style="font-size: 1.25rem; font-weight: 700; color: #dc2626; margin-bottom: 0.25rem;">{{
                  editPermission.rejectedCount }}</div>
    ...
    <div v-if="showDeleteConfirm"
      ...
      <div style="background: white; border-radius: 0.5rem; padding: 2rem; max-width: 400px; width: 100%;" @click.stop>
    ...
    <!-- アカウント削除完了ダイアログ -->
    <AccountDeletedDialog v-if="showDeletedDialog" @close="handleDeletedDialogClose" />
  </div>
</template>
